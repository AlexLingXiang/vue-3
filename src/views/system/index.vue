  ...
  <el-card :shadow="defalutData.cardShadow">
    ...
    >
      ...
      <el-form-item label="系统名字：" prop="systemName">
        <el-input v-model="systemSetting.systemName" class="input-width" />
      </el-form-item>
      ...
      <el-form-item label="公司地址：">
        <el-input v-model="systemSetting.companyAddress" class="input-width" />
      </el-form-item>
      <el-form-item label="公司地址：">
        <el-input v-model="systemSetting.servicePhone" class="input-width" />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleInputChange() {
      ...
      this.systemSetting.introduction =
        this.systemSetting.introduction.substring(0, this.maxLength);
