  ...
  >
    ...
    >
      <el-form-item label="昵称：" prop="nickname">
        <el-input v-model="currentFrom.nickname" style="width: 80%" />
      </el-form-item>

      <el-form-item label="头像：" prop="icon">
        <el-input
          v-model="currentFrom.icon"
          rows="10"
          type="textarea"
          style="width: 80%"
        />
      ...
      <el-form-item label="电话：" prop="phone">
        <el-input v-model="currentFrom.phone" style="width: 80%" />
      </el-form-item>

      <el-form-item label="性别：" prop="gender">
        <el-input v-model="currentFrom.gender" style="width: 80%" />
      </el-form-item>
