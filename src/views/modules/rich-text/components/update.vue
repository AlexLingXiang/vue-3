  ...
  >
    ...
    >
      <el-form-item label="企业名称" prop="name">
        <el-input v-model="currentFrom.name" />
      </el-form-item>
      <el-form-item label="所属行业：" prop="natureOfBusiness">
        <el-input v-model="currentFrom.natureOfBusiness" />
      </el-form-item>
      <el-form-item label="所属领域：" prop="field">
        <el-input v-model="currentFrom.field" style="width: 80%" />
      ...
      <el-form-item label="建筑物名称：" prop="buildingName">
        <el-input v-model="currentFrom.buildingName" style="width: 80%" />
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      <el-form-item label="建筑层数：" prop="buildingFloors">
        <el-input v-model="currentFrom.buildingFloors" style="width: 80%" />
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      <el-form-item label="建筑高度：" prop="buildingHeightb">
        <el-input v-model="currentFrom.buildingHeightb" style="width: 80%" />
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      <el-form-item label="标准话建设情况：" prop="construction">
        <el-input v-model="currentFrom.construction" style="width: 80%" />
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      ...
      <el-form-item label="叉车数量：" prop="forkliftNumber">
        <el-input v-model="currentFrom.forkliftNumber" style="width: 80%" />
        <!-- <svg-icon style="margin-left: 8px" :icon-class="currentFrom.icon"></svg-icon> -->
      </el-form-item>
      ...
      <el-form-item label="结构形式：">
        <el-input v-model="currentFrom.structuralStyle" />
      </el-form-item>
      <el-form-item>
...
<script>
import { modifyEnterprise, addEnterprise } from '@/api/eps/enterprise';
