  ...
  >
    ...
    >
      ...
      <el-form-item label="内容" prop="text">
        <el-input v-model="currentFrom.text" type="textarea" rows="7" />
      </el-form-item>
      ...
      <div class="grid grid-c-2">
        <el-form-item label="原价" prop="oldPrice">
          <el-input v-model="currentFrom.oldPrice" />
        </el-form-item>
        <el-form-item label="现价" prop="price">
          <el-input v-model="currentFrom.price" />
        </el-form-item>
      </div>
      <el-form-item>
